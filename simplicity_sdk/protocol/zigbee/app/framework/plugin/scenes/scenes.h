...
#define sl_zigbee_af_scenes_server_retrieve_scene_entry(entry, i) \
  (void)slx_zigbee_token_manager_get_data(COMMON_TOKEN_SCENES_TABLE + (i), (void *)&entry, sizeof(sl_zigbee_af_scene_table_entry_t))
#define sl_zigbee_af_scenes_server_save_scene_entry(entry, i) \
  (void)slx_zigbee_token_manager_set_data(COMMON_TOKEN_SCENES_TABLE + (i), (void *)&entry, sizeof(sl_zigbee_af_scene_table_entry_t))

#define sl_zigbee_af_scenes_server_num_scene_entries_in_use()                                                                             \
  ((void)slx_zigbee_token_manager_get_data(COMMON_TOKEN_SCENES_NUM_ENTRIES, (void *)&sl_zigbee_af_scenes_server_entries_in_use, sizeof(uint8_t)), \
...
#define sl_zigbee_af_scenes_server_set_num_scene_entries_in_use(x) \
  (sl_zigbee_af_scenes_server_entries_in_use = (x),                \
   (void)slx_zigbee_token_manager_set_data(COMMON_TOKEN_SCENES_NUM_ENTRIES, (void *)&sl_zigbee_af_scenes_server_entries_in_use, sizeof(uint8_t)))
